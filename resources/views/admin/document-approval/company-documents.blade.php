...
@section('title', 'Revisar Documentos de Empresa')

@section('content-documed')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>
            <i class="fas fa-building text-primary"></i>
            Revisar Documentos: {{ $company->company_name }}
        </h1>
            ...
            <div class="card">
                <div class="card-header">
                    <h5>
                        ...
                        Documentos Subidos ({{ $company->documents->count() }})
                    </h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Representante Legal:</strong> {{ $company->legal_representative_dni }}</p>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    @php
                        ...
                        $approved = $company->documents->where('pivot.valid', true)->count();
                        $rejected = $company->documents->where('pivot.valid', false)->count();
    ...
    <script>
        ...
        function processApproval(documentId, action, comments) {
            const url = `{{ route('admin.document-approval.company.approve', ['company' => $company->id, 'document' => '__DOC_ID__']) }}`.replace('__DOC_ID__', documentId);
